...
call_flags="--rmf --bin 500000 -g SLL -p REF"
thresholds=(0.1 0.15 0.2 0.25 0.3 0.35 0.4 0.45 0.5 0.55 0.6 0.65 0.7 0.75 0.8 0.85 0.9 0.95)
call_dir_stem=rmf_fgap_500kb
postprocess_flags="-a lift fgap rmbn --bin 500000 --min 2 --gap 1 --ref SL4 --paf /home/nbrown62/data_mschatz1/nbrown62/panagram_data/tomato_sl4/alignments"
